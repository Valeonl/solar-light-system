...
<a class="back" href="index.html">← Полный вариант (3 368 ₽, панель 30 Вт, аккумулятор 7 А·ч)</a><br><a class="back" href="bt-display.html">Bluetooth-дисплей на аккумуляторе: экран, 18650 и зарядка (1 483 ₽, доставка завтра) →</a>
